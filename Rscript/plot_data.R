plot_index_comparison <- function(df, title = "Index Comparison") {
...
plot_age_comp_normalized <- function(df, title) {
...
plot_weight_trends <- function(df) {
...
plot_survey_vs_catch <- function(survey_df, catch_df) {
